...
# note:
# python reforward.py <jump host> -r <remote_host:remote_port> -p <forward to jump machine port> --user=<jump account> --password
# python reforward.py 192.168.1.103 -r 192.168.1.104:80 -p 8888 --user=kali --password
# in jump host you can get http://127.0.0.1:8888/
#
